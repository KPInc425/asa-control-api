...
export default async function autoUpdateRoutes(fastify, options) {
   ...
   */
  fastify.get('/api/auto-update/status', {
   ...
   */
  fastify.post('/api/auto-update/check-now', {
   ...
   */
  fastify.get('/api/auto-update/servers/:serverName/status', {
    preHandler: [requireRead],
    schema: {
      params: {
        type: 'object',
    ...
    try {
      ...
      const serverConfig = getServerUpdateConfig(serverName);
   ...
   */
  fastify.get('/api/auto-update/servers/:serverName/config', {
    preHandler: [requireRead],
    schema: {
      params: {
        type: 'object',
   ...
   */
  fastify.put('/api/auto-update/servers/:serverName/config', {
    preHandler: [requireWrite],
    schema: {
      params: {
        type: 'object',
    ...
    try {
      ...
      if (updates.checkIntervalMinutes !== undefined) {
        if (updates.checkIntervalMinutes < 5 || updates.checkIntervalMinutes > 1440) {
          return reply.status(400).send({
            success: false,
            message: 'checkIntervalMinutes must be between 5 and 1440 (24 hours)'
          });
        }
      }
      
      // Normalize enabled field (accept both autoUpdateEnabled and enabled)
      const enabled = updates.autoUpdateEnabled !== undefined 
      ...
      if (updates.notifyRcon !== undefined || updates.notifySocket !== undefined || updates.notificationTemplates) {
        try {
          ...
          if (updates.notificationTemplates) {
            dbUpdate.notificationTemplates = JSON.stringify(updates.notificationTemplates);
          }
   ...
   */
  fastify.post('/api/auto-update/servers/:serverName/run-now', {
    preHandler: [requireWrite],
    schema: {
      params: {
        type: 'object',
    ...
    try {
      ...
      if (currentStatus.status === UPDATE_STATUS.WARNING && !force) {
        return reply.status(409).send({
          success: false,
          message: 'Update warning countdown in progress. Use force=true to override.'
        });
      }
   ...
   */
  fastify.post('/api/auto-update/servers/:serverName/cancel', {
    preHandler: [requireWrite],
    schema: {
      params: {
        type: 'object',
   ...
   */
  fastify.post('/api/auto-update/scheduler/start', {
    preHandler: [requireWrite],
    schema: {
      response: {
        200: {
   ...
   */
  fastify.post('/api/auto-update/scheduler/stop', {
    preHandler: [requireWrite],
    schema: {
      response: {
        200: {
   ...
   */
  fastify.post('/api/auto-update/test-notification', {
    preHandler: [requireWrite],
    schema: {
      body: {
        type: 'object',
    ...
    try {
      ...
      if (channels.socket) {
        try {
          ...
          if (io) {
            const socketResult = notifySocket(io, serverName, 'auto-update:test', {
              message,
              type: 'test',
   ...
   */
  fastify.get('/api/auto-update/servers/:serverName/history', {
    preHandler: [requireRead],
    schema: {
      params: {
        type: 'object',
   ...
   */
  fastify.post('/api/auto-update/servers/:serverName/check', {
    preHandler: [requireRead],
    schema: {
      params: {
        type: 'object',
   ...
   */
  fastify.post('/api/auto-update/servers/:serverName/scheduler/start', {
    preHandler: [requireWrite],
    schema: {
      params: {
        type: 'object',
   ...
   */
  fastify.post('/api/auto-update/servers/:serverName/scheduler/stop', {
    preHandler: [requireWrite],
    schema: {
      params: {
        type: 'object',
