...
class ConfigService {
  ...
  get serverRootPath() {
    ...
    console.log(
      `[ConfigService] serverRootPath getter - SERVER_MODE: ${process.env.SERVER_MODE}`,
    );
    console.log(
      `[ConfigService] serverRootPath getter - NATIVE_BASE_PATH: ${process.env.NATIVE_BASE_PATH}`,
    );
    console.log(
      `[ConfigService] serverRootPath getter - config.asa.serverRootPath: ${config.asa.serverRootPath}`,
    );
    console.log(
      `[ConfigService] serverRootPath getter - process.cwd(): ${process.cwd()}`,
    );
    return path;
  }
